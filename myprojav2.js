...
const products = [
  ...
  { name: "زبيب اسود كبير الحب", image: "pho10.jpg", description: "زبيب علاج لفقر الدم", price: 5000 },
  { name: "زبيب اخضر ", image: "phot7.jpg", description: "زبيب اخضر طازج", price: 5000 },
  { name: "زبيب احمر ", image: "pho11.jpg", description: "زبيب احمر ", price: 5000 },
  { name: "زبيب عضوي", image: "pho3.jpg", description: "زبيب خالي من المواد الحافظة", price: 5000 },
  { name: "زبيب  تركي ", image: "phot6.jpg", description: "زبيب اسود تركي شتوي", price: 5000 },
 { name: "زبيب إيراني", image: "pho4.jpg", description: "زبيب مستورد بجودة عالية", price: 2000 },
 { name: "زبيب بني", image: "pho12.jpg", description: "زبيب صيفي غني بالفيتيمينات", price: 5000 }
];
...
function showCart() {
  ...
  cart.forEach((item, i) => {
    ...
    div.innerHTML = `${i + 1}) ${item.name} - ${item.quantity} كيلو - ${item.quantity * item.price} ريال <button onclick="rmoveFromCart(${i})">❌حذف</button>`;
